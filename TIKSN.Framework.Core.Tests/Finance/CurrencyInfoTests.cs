...
public class CurrencyInfoTests
{
    ...
    {
        var currency = new CurrencyInfo(new RegionInfo("en-US"));
    ...
    {
        var germany = new RegionInfo("de-DE");
        var euro = new CurrencyInfo(germany);
    ...
    {
        var unitedStates = new RegionInfo("es-US");
        var usDollar = new CurrencyInfo(unitedStates);
    ...
    {
        var elSalvador = new RegionInfo("SV");
    ...
    {
        var elSalvador = new RegionInfo("es-SV");
        var usDollar = new CurrencyInfo(elSalvador);
    ...
    {
        var ecuador = new RegionInfo("es-EC");
        var usDollar = new CurrencyInfo(ecuador);
    ...
    {
        var r1 = new RegionInfo("en-US");
        var r2 = new RegionInfo("es-US");
        var r3 = new RegionInfo("US");
