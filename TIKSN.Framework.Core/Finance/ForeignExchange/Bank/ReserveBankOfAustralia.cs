...
public class ReserveBankOfAustralia : IReserveBankOfAustralia
{
    ...
    private void PopulateResult(List<ExchangeRate> result, XDocument xdoc)
    {
        lock (this.rates)
        {
    ...
    private void PopulateResultEntry(
        List<ExchangeRate> result,
        XElement? targetCurrencyElement,
        XElement? observationValueElement,
        XElement? periodElement)
    {
        if (targetCurrencyElement is not null
            && observationValueElement is not null
            && periodElement is not null)
        {
    ...
    private void PopulateResultItem(
        XElement item,
        List<ExchangeRate> result)
    {
        var exchangeRateElement = item
        ...
        this.PopulateResultRateElement(exchangeRateElement, result);
    }

    private void PopulateResultRateElement(
        XElement? exchangeRateElement,
        List<ExchangeRate> result)
    {
