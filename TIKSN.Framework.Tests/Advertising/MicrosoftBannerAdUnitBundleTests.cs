...
namespace TIKSN.Framework.Tests.Advertising
{
	public class MicrosoftBannerAdUnitBundleTests
	{
		...
		public void CreateMicrosoftBannerAdUnitBundle()
		{
			...
			var bundle = new MicrosoftBannerAdUnitBundle(tabletApplicationId, tabletAdUnitId, mobileApplicationId, mobileAdUnitId);
