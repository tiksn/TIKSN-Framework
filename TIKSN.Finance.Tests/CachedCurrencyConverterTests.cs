...
namespace TIKSN.Finance.Tests
{
    ...
    public class CachedCurrencyConverterTests
    {
        ...
        //    var date1 = new System.DateTime(2014, 2, 1);
        //    var date2 = new System.DateTime(2014, 3, 1);

        //    decimal rate1 = 2m;
        //    decimal rate2 = 3m;
        //    decimal rate0 = 4m;

        //    ICurrencyConverter fakedCurrencyConverter = new TIKSN.Finance.Fakes.StubICurrencyConverter()
        //    {
        //        GetExchangeRateCurrencyPairDateTime = (currencyPair, asOn) =>
        //            {
        //                callCount++;
        ...
        //                return rate0;
        //            },
        //        ConvertCurrencyMoneyCurrencyInfoDateTime = (baseMoney, counterCurrency, asOn) =>
        //            {
        //                callCount++;

        //                if (asOn == date1)
        //                    return new Money(counterCurrency, baseMoney.Amount * rate1);

        //                if (asOn == date2)
        //                    return new Money(counterCurrency, baseMoney.Amount * rate2);

        //                return new Money(counterCurrency, baseMoney.Amount * rate0);
        //            }
        //    };

        //    CachedCurrencyConverter cachedConverter = new CachedCurrencyConverter(fakedCurrencyConverter, interval, interval);

        //    var pair = Helper.SampleCurrencyPair1;
        //    var testBaseMoney = new Money(pair.BaseCurrency, 100m);
        ...
        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<Money>(new Money(pair.CounterCurrency, testBaseMoney.Amount * rate1), convertedMoney1);
        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<int>(1, cachedConverter.RatesCacheSize);

        //    var convertedMoney2 = cachedConverter.ConvertCurrency(testBaseMoney, pair.CounterCurrency, date2);

        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<Money>(new Money(pair.CounterCurrency, testBaseMoney.Amount * rate2), convertedMoney2);
        ...
        //            {
        //                rateCallCount++;
        //                return new Money(targetCurrency, Helper.GetRandomForeignExchangeRate() * baseMoney.Amount);
        //            },

        //        GetCurrencyPairsDateTime = (asOn) =>
        //            {
        //                currencyPairsCallCount++;
        //                return Helper.SampleCurrencyPairs1;
        //            },
        //        GetExchangeRateCurrencyPairDateTime = (currencyPair, asOn) =>
        //            {
        //                rateCallCount++;
        //                return Helper.GetRandomForeignExchangeRate();
        //            },
        //    };
        ...
        //    {
        //        GetExchangeRateCurrencyPairDateTime = (pair, asOn) =>
        //        {
        //            rateCallCount++;
        //            return Helper.GetRandomForeignExchangeRate();
        //        },
        //        ConvertCurrencyMoneyCurrencyInfoDateTime = (money, currency, asOn) =>
        //        {
        //            rateCallCount++;
        //            return new Money(currency, money.Amount * Helper.GetRandomForeignExchangeRate());
        //        }
        //    };

        //    CachedCurrencyConverter cachedConverter = new CachedCurrencyConverter(fakedConverter, interval, interval, capacity, null);

        //    cachedConverter.ConvertCurrency(Helper.SampleMoney1, Helper.SampleCurrency2, new System.DateTime(2014, 10, 1));
        //    cachedConverter.GetExchangeRate(Helper.SampleCurrencyPair1, new System.DateTime(2014, 9, 1));

        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<int>(2, cachedConverter.RatesCacheSize);
        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<int>(2, rateCallCount);

        //    cachedConverter.ConvertCurrency(Helper.SampleMoney1, Helper.SampleCurrency2, new System.DateTime(2014, 8, 1));

        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<int>(2, cachedConverter.RatesCacheSize);
        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<int>(3, rateCallCount);

        //    cachedConverter.ConvertCurrency(Helper.SampleMoney1, Helper.SampleCurrency2, new System.DateTime(2014, 9, 1));
        //    cachedConverter.ConvertCurrency(Helper.SampleMoney1, Helper.SampleCurrency2, new System.DateTime(2014, 8, 1));
        ...
        //    ICurrencyConverter converter = new TIKSN.Finance.Fakes.StubICurrencyConverter()
        //    {
        //        ConvertCurrencyMoneyCurrencyInfoDateTime = (baseMoney, targetCurrency, asOn) => { callsCount++; return new Money(targetCurrency, baseMoney.Amount * Helper.GetRandomForeignExchangeRate()); }
        //    };
        ...
        //    var date1 = new System.DateTime(2014, 11, 21);
        //    var date2 = new System.DateTime(2014, 11, 23);
        //    var date3 = new System.DateTime(2014, 11, 25);

        //    Money convertedMoney1 = new Money(Helper.SampleCurrency1, 101m);
        //    Money convertedMoney2 = new Money(Helper.SampleCurrency1, 102m);
        //    Money convertedMoney3 = new Money(Helper.SampleCurrency1, 103m);
        ...
        //                if (asOn == date1)
        //                    return convertedMoney1;

        //                if (asOn == date2)
        //                    return convertedMoney2;

        //                if (asOn == date3)
        //                    return convertedMoney3;
        ...
        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<Money>(convertedMoney1, cachedConverter.ConvertCurrency(testBaseMoney, testBaseCurrency, date1));
        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<int>(1, callsCount);

        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<Money>(convertedMoney2, cachedConverter.ConvertCurrency(testBaseMoney, testBaseCurrency, date2));
        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<int>(2, callsCount);

        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<Money>(convertedMoney3, cachedConverter.ConvertCurrency(testBaseMoney, testBaseCurrency, date3));
        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<int>(3, callsCount);

        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<Money>(convertedMoney1, cachedConverter.ConvertCurrency(testBaseMoney, testBaseCurrency, new System.DateTime(2014, 11, 22)));
        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<int>(3, callsCount);

        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<Money>(convertedMoney2, cachedConverter.ConvertCurrency(testBaseMoney, testBaseCurrency, new System.DateTime(2014, 11, 24)));
        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<int>(3, callsCount);

        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<Money>(convertedMoney3, cachedConverter.ConvertCurrency(testBaseMoney, testBaseCurrency, new System.DateTime(2014, 11, 26)));
        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<int>(3, callsCount);
        ...
        //    CachedCurrencyConverter cachedConverter = new CachedCurrencyConverter(fakedConverter, interval, interval, null, capacity);
        ...
        //    var pair1 = Helper.SampleCurrencyPairs1;
        //    var pair2 = Helper.SampleCurrencyPairs2;
        ...
        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(pair1.SequenceEqual(cachedConverter.GetCurrencyPairs(new System.DateTime(2014, 11, 22))));
        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<int>(2, callsCount);

        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(pair2.SequenceEqual(cachedConverter.GetCurrencyPairs(new System.DateTime(2014, 11, 24))));
        //    Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<int>(2, callsCount);
        ...
        //	var testPair = Helper.SampleCurrencyPair1;
        //	var testMoney = new Money(testPair.BaseCurrency, 111m);
        ...
        //	cachedConverter.ConvertCurrency(testMoney, testPair.CounterCurrency, new System.DateTime(2014, 8, 1));
        ...
        //	ICurrencyConverter converter = new TIKSN.Finance.Fakes.StubICurrencyConverter()
        //	{
        //		GetExchangeRateCurrencyPairDateTime = (pair, dateTime) => { callsCount++; return Helper.GetRandomForeignExchangeRate(); }
        //	};
        ...
        //	Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<decimal>(rate1, cachedConverter.GetExchangeRate(currencyPair, date1));
        //	Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<int>(1, callsCount);

        //	Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<decimal>(rate2, cachedConverter.GetExchangeRate(currencyPair, date2));
        //	Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<int>(2, callsCount);

        //	Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<decimal>(rate3, cachedConverter.GetExchangeRate(currencyPair, date3));
        //	Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<int>(3, callsCount);

        //	Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<decimal>(rate1, cachedConverter.GetExchangeRate(currencyPair, new System.DateTime(2014, 11, 22)));
        //	Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<int>(3, callsCount);

        //	Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<decimal>(rate2, cachedConverter.GetExchangeRate(currencyPair, new System.DateTime(2014, 11, 24)));
        //	Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<int>(3, callsCount);

        //	Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<decimal>(rate3, cachedConverter.GetExchangeRate(currencyPair, new System.DateTime(2014, 11, 26)));
        //	Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual<int>(3, callsCount);
