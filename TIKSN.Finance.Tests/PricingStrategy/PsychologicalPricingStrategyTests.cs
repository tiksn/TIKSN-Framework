...
// Assert.AreEqual(expectedEstimatedPrice, actualEstimatedPrice, "Actual: {0} Expected: {1}",
// actualEstimatedPrice, expectedEstimatedPrice); } }

// [TestMethod] public void EstimatedPriceIsPrimarelyBeneficial() { var ratios = new List<decimal>();
